      ...
      <div className="container">
        <div className="row">
          <div className="col-12 text-center">
            <ul key="list-repositories" data-testid="repository-list" className="list-repositories">
              <h2 className="mb40">Repositórios</h2>
              {repositories.map(repository =>
                <ul className="itemList" key={repository.id}>
                  <li className="name-link">
                    <a target="_blank" rel="noopener noreferrer" href={repository.url} > {repository.title}</a>
                  </li>
                  <li className="itemLike" >
                    <button className="btnLike" onClick={() => handleLike(repository.id)}>
